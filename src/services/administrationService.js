...
const { buildBalanceDifferences } = require('./administration/balanceDifferences');
const {
  OFFICER_ROLES,
  requireDate,
  validateArchive,
...
function createAdministrationService(db) {
  ...
  return {
    ...
    getBalanceDifferences() {
      return buildBalanceDifferences(
        repository.listShareBalanceDifferences(),
        repository.listCompositionBalanceSources(),
