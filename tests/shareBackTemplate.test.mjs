...
assert.match(html, /ΣΕ ΜΕΤΑΦΟΡΑ/u);
assert.match(html, /Κ 2309\/ΔΥΠ/u);
assert.match(html, /32\. ΥΠΑΡΧΟΝΤΑ/u);
assert.match(html, /33\. ΔΙΑΦΟΡΑ/u);
assert.match(html, /official-share-back-date-heading/u);
assert.match(styles, /\.official-share-back-table th:nth-child\(2\) \{ width: 5\.8%; \}/u);
assert.match(styles, /\.official-share-back-table th:nth-child\(3\) \{ width: 12\.5%; \}/u);
assert.match(styles, /\.official-share-back-table th:nth-child\(4\) \{ width: 16\.3%; \}/u);
assert.match(styles, /\.official-share-back-table th:nth-child\(8\) \{ width: 18%; \}/u);
