...
assert.match(addyFormSource, /Θέλετε να γίνει.*Μερικές Διαχειρίσεις/su);
assert.match(addyFormSource, /openAddyCompositionAllocationDialog/u);
assert.match(addyFormSource, /ΧΡΕΩΣΗ.*ΠΙΣΤΩΣΗ.*ΥΛΙΚΩΝ ΣΥΝΘΕΣΗΣ/su);
