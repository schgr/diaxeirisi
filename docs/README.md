...
2. Δημιουργήστε release με tag `v0.13.233`.
3. Επισυνάψτε και τα τέσσερα αρχεία, διατηρώντας ακριβώς τις παρακάτω
   ονομασίες:

```text
diaxeirisi-Ylikoy-Setup-0.13.233.exe
diaxeirisi-Ylikoy-Windows-10-11-x86-Setup-0.13.233.exe
diaxeirisi-Ylikoy-Windows-7-Legacy-Setup-0.13.233.exe
diaxeirisi-Ylikoy-Windows-7-SP1-x86-Legacy-Setup-0.13.233.exe
```
